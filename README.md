...
This is version 0.4.2. It's the changes I'm making while rewriting "One Key Piano". I'm finding that i want more freedom and less work.

* I have removed some complexities I found.
* Fixed a bug with record storage.
* Fixed a bug in the apptabs panel and the doctabs panel.
* I improved the documentation when some commands are succesfuly completed adding links to the newly added files. Those links work in vscode's terminal.
* Made the application startup much faster.

Shown below is a dump of kickfyne's help.
...
1. A search for KICKFYNE TODO will reveal instructions for proper developement and management of the message and handler operation.
   ...
   1. The message's back-end handler needs functionality added.
