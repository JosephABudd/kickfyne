...
func NewMiscellaneous(ctx context.Context, ctxCancel context.CancelFunc, app fyne.App, w fyne.Window, layout *_layout_.Layout, id string) (components *Miscellaneous, err error) {
