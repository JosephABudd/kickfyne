...
func NewContent(tabItemContentConsumer *_types_.AppTabsTabItemContentConsumer, screen *_misc_.Miscellaneous, tabItem *container.TabItem, paneler _types_.Paneler) (panelContent *Content, err error) {
