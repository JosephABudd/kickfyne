...
func LogContent(
	...
	// Shared Messages
	messageNameStructName := _utils_.AppTabMessageNameStructName(screenPackageName)
	messageFolderPath := _utils_.AppTabSharedMessageFolderPath(screenPackageName, folderPaths)
	messageNameFileName := _utils_.AppTabMessageNameFileName(screenPackageName)
	messageNameDescription := _utils_.AppTabMessageNameDescription()
	builder.WriteString("\nShared messages:\n")
	...
	// Back-end Messengers
	messengerFolderPath := _utils_.AppTabBackendMessengerFolderPath(screenPackageName, folderPaths)
	builder.WriteString("\nBack-end messengers:\n")
	for messageName, messageFileName := range messageNameFileName {
